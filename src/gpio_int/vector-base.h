...
cp_asm(vector_reg, p15, 0, c12, c0, 0);
...
static inline void *vector_base_get(void) {
    ...
    return (unsigned int*) vector_reg_get();
}
...
static inline void vector_base_set(void *vec) {
    ...
    vector_reg_set((unsigned int)vec);
